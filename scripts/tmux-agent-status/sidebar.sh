...
# dark-terminal palette. Truecolor is safe here since .tmux.conf sets
# `terminal-overrides ",*256col*:Tc"`.
RST=$'\033[0m'
BOLD=$'\033[1m'
DIM=$'\033[2m'
UND=$'\033[4m'
YEL=$'\033[38;2;154;73;41m'    # working - token-light accent orange #9a4929
GRN=$'\033[38;2;91;125;79m'    # done - muted sage green #5b7d4f
MAG=$'\033[38;2;176;85;85m'    # inbox/ask accent - token-light red #b05555
CYN=$'\033[38;2;82;117;148m'   # waiting - token-light blue #527594
GRY=$'\033[38;2;133;129;121m'  # parked/dim icon - token-light border gray #858179
WHT=$'\033[38;2;61;57;41m'     # token-light default fg #3d3929
BYEL=$'\033[1;38;2;154;73;41m'
BGRN=$'\033[1;38;2;91;125;79m'
BMAG=$'\033[1;38;2;176;85;85m'
BCYN=$'\033[1;38;2;82;117;148m'
# Selection highlight: subtle background
SEL_BG=$'\033[48;2;221;220;214m'  # token-light mode-style bg #dddcd6
CUR_BG=$'\033[48;2;232;230;223m'  # lighter tint between status bg and SEL_BG
ACC_GRN=$'\033[38;2;154;73;41m'   # current-session accent bar - orange #9a4929
